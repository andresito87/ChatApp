<script lang="ts">
  ...
  // Redirects user to home if already authenticated
  onMount(() => {
    if ($authToken) {
      navigate("/");
    }
  ...
  // this function is called when the form is submitted and redirects the user to the login page
...
<div class="auth-container">
  <!-- When the form is submitted, the register function is called. 
